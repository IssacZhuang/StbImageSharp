			...
			*pvertices = null;
			...
			else if (numberOfContours < 0)
			{
				...
				while (more != 0)
				{
					...
					m = CRuntime.sqrt(mtx[0] * mtx[0] + mtx[1] * mtx[1]);
					n = CRuntime.sqrt(mtx[2] * mtx[2] + mtx[3] * mtx[3]);
			...
			scale_y = -scale_y;
			{
				...
				for (i = 0, j = num_verts - 1; i < num_verts; j = i++)
					if (verts[i].type == STBTT_vline)
					{
						...
						var dist = CRuntime.sqrt((x1 - x0) * (x1 - x0) + (y1 - y0) * (y1 - y0));
